...
def pipeline_libros_buscalibre():
    ...
    def run_ingesta_bronze(logical_date=None) -> str:
        ...
        ruta_archivo_bronze = ingesta_bronze(
            url=url, headers=headers, fecha_logica=fecha_ejecucion, raiz_proyecto=RUTA_CONTENEDOR
        )
    ...
    def run_ingesta_silver(ruta_archivo_bronce: str, **context):
        ...
        ruta_archivo_silver = procesar_silver(
            fecha_logica=fecha_ejecucion, raiz_proyecto=RUTA_CONTENEDOR, bronce_file=ruta_archivo_bronce
        )
    ...
    def run_ingesta_gold(ruta_archivo_silver: str, **context):
        ...
        diccionario_rutas_gold = generar_gold(
            fecha_logica=fecha_ejecucion, raiz_proyecto=RUTA_CONTENEDOR, silver_file=ruta_archivo_silver
        )

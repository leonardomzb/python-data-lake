...
def generar_gold(silver_file: str, fecha_logica: str, raiz_proyecto: Path) -> bool:
    try:
        ...
        logger.info("Comenzando a procesar capa Gold...")
        df_silver = pl.scan_parquet(silver_file)

        logger.info("Generando dim_editorial...")
        dim_editorial = (
        ...
        logger.info("Generando dim_autor...")
        dim_autor = (
        ...
        logger.info("Generando dim_libro...")
        dim_libro = (
        ...
        logger.info("Generando fact_ranking...")
        fact_ranking = (
        ...
        logger.info("¡Proceso de ingesta Gold finalizado con éxito!")
        rutas_gold = {
